...
Please note that I have changed the `showDetailsInAlert()` method to accommodate the Codable Contact object instead of a String between lines 49 through 60.
